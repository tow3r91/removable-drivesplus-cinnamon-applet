...
class DriveMenuItem extends PopupMenu.PopupBaseMenuItem {
    constructor(place, applet) {
        ...
        let mountTarget= place.id.substring(12);

        let [res, out] = GLib.spawn_command_line_sync('df -h --output=avail '+mountTarget);
        this.labelAvailable = new St.Label({ text: ""+out });
        this.addActor(this.labelAvailable);
